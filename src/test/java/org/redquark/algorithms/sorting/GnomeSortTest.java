...
public class GnomeSortTest {
    ...
    @Test
    public void gnomeSortIntegerTest() {
        ...
        Assert.assertArrayEquals(sorted, gnomeSort.sort(unsorted));
    }

    @Test
    public void gnomeSortFloatTest() {
    ...
    @Test
    public void gnomeSortCharacterTest() {
    ...
    @Test
    public void gnomeSortStringTest() {
