...
public class BogoSortTest {
    ...
    @Test
    public void bogoSortIntegerTest() {
        ...
        Assert.assertArrayEquals(sorted, bogoSort.sort(unsorted));
    }

    @Test
    public void bogoSortFloatTest() {
    ...
    @Test
    public void bogoSortCharacterTest() {
    ...
    @Test
    public void bogoSortStringTest() {
