...
public class CocktailShakerSortTest {
    ...
    @Test
    public void cocktailShakerSortIntegerTest() {
        ...
        Assert.assertArrayEquals(sorted, cocktailShakerSort.sort(unsorted));
    }

    @Test
    public void cocktailShakerSortFloatTest() {
    ...
    @Test
    public void cocktailShakerSortCharacterTest() {
    ...
    @Test
    public void cocktailShakerSortStringTest() {
