...
public class CycleSortTest {
    ...
    private CycleSort cycleSort = new CycleSort();
    ...
    public void cycleSortIntegerTest() {
        ...
        Assert.assertArrayEquals(sorted, cycleSort.sort(unsorted));
    }

    @Test
    public void cycleSortFloatTest() {
    ...
    @Test
    public void cycleSortCharacterTest() {
    ...
    @Test
    public void cycleSortStringTest() {
