...
public class PancakeSortTest {
    ...
    @Test
    public void pancakeSortIntegerTest() {
        ...
        Assert.assertArrayEquals(sorted, pancakeSort.sort(unsorted));
    }

    @Test
    public void pancakeSortFloatTest() {
    ...
    @Test
    public void pancakeSortCharacterTest() {
    ...
    @Test
    public void pancakeSortStringTest() {
